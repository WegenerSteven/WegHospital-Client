...
function DashboardOverview() {
  ...
  const canViewPatients = user?.role === 'admin' || user?.role === 'doctor' || user?.role === 'patient'
  const canViewDoctors = user?.role === 'admin' || user?.role === 'doctor'
  const canViewAppointments = user?.role === 'admin' || user?.role === 'doctor' || user?.role === 'patient'
  ...
  return (
    <ProtectedRoute requiredRoles={['admin', 'doctor', 'patient', 'user']}>
